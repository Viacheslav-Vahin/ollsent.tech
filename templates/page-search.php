...
<div class="dp_container">
    <form method="get" action="<?php echo esc_url(site_url('/')); ?>">
        <input class="si" type="search" name="s">
...
<form class="search-form" role="search" method="get" id="searchform" action="<?php echo home_url('/') ?>">
    <input class="search-form__input" type="text" value="<?php echo get_search_query() ?>" name="s" id="s" placeholder="Поиск на сайте WordPress" autocomplete="off" />
