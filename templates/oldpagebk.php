<?php
/*
Template Name: OLDБаза кандидатов
*/
        ...
        <div class="vac_wrap">
            <div class="left_vac pipe">
                <div id="pipe_filtrs" class="vac_filtrs">
                    ...
                    <!--                <div class="all_tech_wrapper">-->
                    <!--                    <div class="q_a togleShow fh">-->
                    <!--                        <h3 class="accordion-title">Технології/Методології/Фреймворки:-->
                    <!--                            <div class="qa_icon_wrapper tran">-->
                    <!--                                <span class="dashicons dashicons-arrow-right-alt2 tran"></span>-->
                    <!--                            </div>-->
                    <!--                        </h3>-->
                    <!--                        <div class="boxForChosenTechSpec"></div>-->
                    <!--                        <div class="answ">-->
                    <!--                            <select class="lang_left so" id="vac_techspeciality">-->
                    ...
                    <!--                                    --><?php
                    //                                } ?>
                    <!--                                <option class="countTechLang">--><?php //echo $countAddLang; ?><!--</option> --><?php
                    //                                wp_reset_postdata();
                    //                                ?>
                    <!--                            </select>-->
                    <!--                        </div>-->
                    ...
                    <div class="city_wrapper" style="display: block;">
                        <div class="q_a togleShow fh">
                            ...
                            <div class="answ">
                                ...
                                <!--                                <option value="">Всі Региони</option>-->
                                <!--                                --><?php //$countCity = 0;
                    ...
                    <?php while ($recomendData->have_posts()) {
                        ...
                        ?>>
                            ...
                            <span class="dnone">a</span></span>
                                ...
                                <?php $cand_addctegory = get_field('addspec1');
                                if($cand_addctegory) {
                                    foreach ($cand_addctegory as $ak) {
                                        ?>
                                        <span class="spec1">
                            <?php
                            echo $ak->post_title;
                            if (next($cand_addctegory)) {
                                echo ',';
                            }
                            ?>
                            <span class="dnone">a</span></span>
