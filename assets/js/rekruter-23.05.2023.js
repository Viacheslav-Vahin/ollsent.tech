...
// Проверка наличия сохраненных фильтров при загрузке страницы
    ...
    `);
        ...
        // let selectedCountries = localStorage.getItem('selectedCountries');
        // if (selectedCountries) {
        //     selectedCountries = JSON.parse(selectedCountries) || [];
        // } else {
        //     selectedCountries = [];  // или установите значения по умолчанию здесь
        // }
        //
        // let selectedValues = localStorage.getItem('selectedValues');
        // if (selectedValues) {
        //     selectedValues = JSON.parse(selectedValues) || [];
        // } else {
        //     selectedValues = [];  // или установите значения по умолчанию здесь
        // }
        //
        // let blacklistChecked = localStorage.getItem('blacklistChecked');
        // if (blacklistChecked) {
        //     blacklistChecked = JSON.parse(blacklistChecked) || false;
        // } else {
        //     blacklistChecked = false;  // или установите значения по умолчанию здесь
        // }
        ...
        if (typeof filters === 'undefined' || filters === null || typeof selectedCountries === 'undefined' || selectedCountries === null || typeof selectedValues === 'undefined' || selectedValues === null || typeof blacklistChecked === 'undefined' || blacklistChecked === null) {
        ...
        // return $('.kandItem1:visible').length;
        hideLoader();
    }
